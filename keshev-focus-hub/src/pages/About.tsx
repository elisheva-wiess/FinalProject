...
const aboutTexts = [
  ...
  "צוות המומחים שלנו משלב גישות טיפול מתקדמות עם יחס חם ואנושי: טיפול קוגניטיבי-התנהגותי (CBT), טיפול בתנועה, סביבה טבעית ושלווה – כל אלה יוצרים מעטפת הוליסטית להתפתחות רגשית וקוגניטיבית.",
